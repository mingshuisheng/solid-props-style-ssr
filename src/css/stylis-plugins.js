...
export const createUnsafeSelectorsAlarm =
  (cache) => (element, index, children) => {
...
export const incorrectImportAlarm = (element, index, children) => {
